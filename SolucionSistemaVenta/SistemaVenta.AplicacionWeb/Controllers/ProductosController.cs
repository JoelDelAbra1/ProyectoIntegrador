...
namespace SistemaVenta.AplicacionWeb.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(IMapper mapper, IProductoService productoServicio, ICategoriaService categoriaServicio)
        {
            _mapper = mapper;
        ...
        public async Task<IActionResult> Crear([FromForm] IFormFile imagen, [FromForm] string modelo)
        {
            ...
            try
            {
                ...
                if(imagen != null)
                {
                    ...
                    nombreImagen = string.Concat(nombre_en_codigo, extencion);
