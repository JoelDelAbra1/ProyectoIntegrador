...
{
    public class MenuViewComponentcs:ViewComponent
    {
        private readonly IMenuService _menuServicio;
        private readonly IMapper _mapper;
        public MenuViewComponentcs(IMenuService menuServicio,
            IMapper mapper)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync(){
            ...
            if (claimUser.Identity.IsAuthenticated)
            {
                ...
                listaMenus = _mapper.Map<List<VMMenu>>(await _menuServicio.ObtenerMenu(int.Parse(IdUsuario)));
